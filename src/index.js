...
// se crea un store con datos de un objeto/api
const store = createStore(reducer, initialState, composeEnhancers);
// encapsula a la APP principal en un provider para que todos tengan acceso al store, es decision de cada componente el usarlo o no
ReactDOM.render(
